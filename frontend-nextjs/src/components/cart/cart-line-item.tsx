          ...
          <div className="flex flex-1 items-end justify-between text-sm">
            <div className="flex items-center gap-1">
              <button
                ...
                disabled={isLoading}
                className="flex size-7 items-center justify-center rounded border border-gray-300 bg-white text-gray-600 hover:bg-gray-50 hover:border-gray-400 disabled:opacity-50 cursor-pointer"
              >
                −
              </button>
              <div className="flex h-7 min-w-12 items-center justify-center rounded border border-gray-300 bg-gray-50 px-2 text-sm font-medium text-gray-900">
                {item.quantity}
              </div>
              <button
                type="button"
            ...
            <div className="flex">
              ...
              >
                <XMarkIconMini aria-hidden="true" className="size-4 text-red-500" />
                Remove
              </button>
            </div>
          </div>
